"""HyperCLOVAX로 Fashion VLM 공통 프롬프트를 실행해 JSONL 결과를 만든다."""
...
DEFAULT_MODEL = "naver-hyperclovax/HyperCLOVAX-SEED-Vision-Instruct-3B"
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--output", default=str(ROOT / "results" / "hyperclova_14field.jsonl")
    )
